...
export const listing = {
  ...
  highlights: ["The original hut roof and trapezoid windows", "Farm-to-table salad bar, picked out back", "Red pendant lamps, all on dimmers", "Arcade corner with a working jukebox"],
  bedrooms: [
  ...
  photos: {
    ...
    tub: "The salad bar, restored, with its sneeze guard and cold well, laid out with produce cut from the garden that morning",
    garden: "The kitchen garden out back: raised beds, a fire pit, string lights and the old sign pole carrying the house number",
...
export const featuredReview: Record<Viewport, string> = {
  ...
  tablet:
    "We booked it for the joke and stayed for the beds. Red lamps on low, checkered cloths, a pie from the wood oven, the jukebox on the good side of loud. The salad bar runs on whatever is ready in the garden. Perfect.",
  desktop:
    "We booked it for the joke and stayed for the beds. Red lamps on low, checkered cloths, a pie from the wood oven, the jukebox on the good side of loud, and a salad bar stocked from the beds out back. The hosts thought about everything a real weekend needs. We are already planning a winter return.",
};
...
export const hostBio: Record<Viewport, string> = {
  mobile:
    "We bought the hut at auction, spent a year putting it back, and now share it. We live nearby, answer fast, and keep the garden picked.",
  tablet:
  ...
  desktop:
    "We bought the hut at auction in 2023 after driving past it for years, spent twelve months putting it back the way we remembered it from birthday parties, and now share it most of the year. We live ten minutes away, answer messages quickly, and leave the salad bar stocked from the garden, the oven wood stacked, and the jukebox loaded. Dee runs the kitchen and the beds out back; Marcus keeps the arcade cabinet alive. Ask us about the creek path, the good diner on Main Street, the drive-in in summer, and the best booth to watch the rain from.",
};
...
export const descriptionFull: string[] = [
  ...
  "The dining room is the living room. Six booths, checkered cloths, lamps on dimmers, a jukebox that works and an arcade cabinet that mostly does. The salad bar is cold every day and stocked from the raised beds out back, which you are welcome to pick. Behind the fence, where the dumpster pad was, there is a fire pit and a hot tub.",
...
const featured = new Set([
  "Wood-fired pizza oven", "Farm-to-table salad bar", "A full set of red tumblers",
...
export const amenityGroups: { title: string; items: string[] }[] = [
  { title: "Kitchen and dining", items: ["Wood-fired pizza oven", "Farm-to-table salad bar", "A full set of red tumblers", "Booth seating for eight", "Checkered tablecloths", "Full refrigerator and freezer", "Dishwasher", "Coffee maker and grinder", "Pots, pans, plates and a peel", "Dining room smart TV", "Washer and dryer"] },
  ...
  { title: "Outdoors", items: ["Kitchen garden, pick what you like", "Hot tub on the back patio", "Free parking in the old lot, four cars and a boat", "Patio furniture", "Fire pit", "Bike rack", "Fenced yard for dogs"] },
...
export const allReviews: { name: string; city: string; when: string; text: string; short?: string }[] = [
  ...
  { name: "Mei", city: "Hoboken, New Jersey", when: "June 2026", text: "Cutting your own salad out of the garden before dinner is a genuinely good idea and someone should steal it. Walkable to Main Street, the creek path is lovely, parking is easy. We would come back in winter for the lamps." },
...
export const photoSet: { key: "hero" | "dining" | "arcade" | "bedroom" | "kitchen" | "bed1" | "bed2" | "saladBar" | "garden"; caption: string; alt: string }[] = [
  ...
  { key: "saladBar", caption: "The salad bar, farm to table", alt: listing.photos.tub },
  { key: "garden", caption: "The kitchen garden and fire pit", alt: listing.photos.garden },
];
